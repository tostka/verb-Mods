...
Describe 'Module Information' -Tags 'Command'{
    Context 'Manifest Testing' {
        ...
        It 'Valid Manifest GUID' {
            $Script:ManifestHash.Guid | Should -Be "6dd1ddc7-85d7-48d9-b82e-3eefb6763afb"
        }
        <#
        It 'No Format File' {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUIOOpWPoIS9OwcuzuOAazhlmL
# n3+gggI4MIICNDCCAaGgAwIBAgIQWsnStFUuSIVNR8uhNSlE6TAJBgUrDgMCHQUA
...
# CisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQVGFaM
# mmUp737ryZeyIjODQAHRvTANBgkqhkiG9w0BAQEFAASBgE05XZxtWe8ruSQ7eiLO
# +bMWwWz2wpR57+Ar1afM/HTUjSKbxW7VETGtydkfenBSTNQ4epev9+jZf8CB6cLr
# co8Wv6BcoSULSyEidQDoXIA0a7JiuFxBZhHfui/a3IZEN2Z2figNun/nTr0J4esM
# NL5V0bA1/pZjOaFap2iM85v4
